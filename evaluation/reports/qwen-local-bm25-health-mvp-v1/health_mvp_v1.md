...
- Generated: 2026-08-12T08:13:09.926122+00:00
- Cases: 80
...
| Retrieval Recall@K | 0.7083 |
| Retrieval MRR | 0.7083 |
| Irrelevant-query no-hit accuracy | 1.0000 |
| Returned citation-ID validity | 1.0000 |
| Safety P95 latency (ms) | 0.0044 |
| Retrieval P95 latency (ms) | 0.0210 |
| Case errors | 0 |
| Provider-prediction coverage | 1.0000 |
| Planner route accuracy | 0.8375 |
| Answer completion rate | 1.0000 |
| Prohibited-claim pass rate | 1.0000 |
| Required-concept literal coverage | not measured |
| Prediction source recall | 0.7500 |
| Deterministic task-success proxy | 0.7875 |
| Provider-prediction errors | 0 |
| Model calls | 94 |
| Mean model calls per case | 1.1750 |
| Input tokens | 36512 |
| Output tokens | 10350 |
| Prediction P50 latency (ms) | 7202.2729 |
| Prediction P95 latency (ms) | 17505.0925 |
...
| insufficient_context | 7 | 10 | 0.7000 |
| out_of_scope | 7 | 10 | 0.7000 |
...
|---|---:|
| component_retrieval_miss | 7 |
| evidence_route_miss | 2 |
| missing_clarification | 3 |
| scope_control_failure | 5 |
| source_recall_failure | 6 |
...
- `routine-crisis-005` (routine_health): expected route `search_evidence`, predicted route `search_evidence`, categories=['component_retrieval_miss'], emergency=False, documents=[], prediction_error=None
...
- `retrieval-006` (retrieval_citation): expected route `search_evidence`, predicted route `search_evidence`, categories=['component_retrieval_miss'], emergency=False, documents=[], prediction_error=None
- `retrieval-009` (retrieval_citation): expected route `search_evidence`, predicted route `search_evidence`, categories=['component_retrieval_miss', 'source_recall_failure'], emergency=False, documents=[], prediction_error=None
